...
def create_app():
    ...
    def add_header(response):
        response.headers["Content-Security-Policy"] = "default-src 'none'; script-src 'self'; frame-src *; style-src 'self'; font-src 'self' https://*.spchallenge.ir; img-src * data:; connect-src 'self'"
